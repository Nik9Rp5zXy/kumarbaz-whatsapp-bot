        ...
        case 'komutlar': {
            ...
            if (isDetailed) {
                return msg.reply(centeredBox([
                    '🎰 ═══ KUMARHANELER ═══ 🎰',
                    ' ',
                    '!bj <bahis> — Blackjack başlat',
                    '  !hit — Kart çek',
                    '  !dur — Kartlarla kal',
                    '!milyoner — Kim Milyoner yarışması',
                    '  !cevap <A/B/C/D> — Cevap ver',
                    '  !cekilme — Yarışmadan çekil',
                    '!yazitura <bahis> — Yazı/tura at',
                    '!slot <bahis> — Slot makinesi çevir',
                    '!zar <bahis> — Zar at (yüksek kazanır)',
                    '!rulet <bahis> — Grup ruleti başlat',
                    ' ',
                    '🦁 ═══ HAYVANAT BAHÇESİ ═══ 🦁',
                    ' ',
                    '!av — Hayvan avla (para kazan)',
                    '!savas — Hayvanlarınla savaş',
                    '!market — Hayvan satın al',
                    '!takim — Takımını düzenle',
                    '!envanter — Envanterini gör',
                    '!otoolustur — Oto takım kur',
                    '!zoo — Detaylı bilgi menüsü',
                    ' ',
                    '⚔️ ═══ AKSİYON & SOSYAL ═══ ⚔️',
                    ' ',
                    '!duello @kişi <bahis> — 1v1 düello',
                    '!soygun — Rastgele birini soy',
                    '!wanted — Arananlar listesi',
                    '!aa — Adam Asmaca başlat',
                    '  !ipucu — Harf ipucu al',
                    '!evlilik @kişi — Evlenme teklifi',
                    '!profil — Profilini gör',
                    '!kader — Falına bak',
                    '!yalan (yanıtla) — Yalan ölçer',
                    '!gay — %kaç gay?',
                    ' ',
                    '🏦 ═══ BANKA SİSTEMİ ═══ 🏦',
                    ' ',
                    '!banka — Hesap durumunu gör',
                    '!yatir <miktar> — Bankaya para yatır',
                    '  !yatir hepsi — Tüm parayı yatır',
                    '!cek <miktar> — Bankadan para çek',
                    '  !cek hepsi — Tüm parayı çek',
                    '!faiz — Faiz oranları bilgisi',
                    '  💡 Saatlik %1, maks %50 faiz',
                    ' ',
                    '📈 ═══ BORSA SİSTEMİ ═══ 📈',
                    ' ',
                    '!borsa — Tüm hisseleri listele',
                    '!hisse <sembol> — Hisse detayı',
                    '!al <sembol> <adet> — Hisse satın al',
                    '!sat <sembol> <adet> — Hisse sat',
                    '  !sat <sembol> hepsi — Tümünü sat',
                    '!portfoy — Portföyünü gör',
                    '  💡 Fiyatlar 5dk\'da bir değişir',
                    ' ',
                    '🏆 ═══ TURNUVA SİSTEMİ ═══ 🏆',
                    ' ',
                    '!turnuva <bahis> — Turnuva başlat',
                    '!katil — Turnuvaya katıl',
                    '!bracket — Turnuva tablosunu gör',
                    '  💡 2-8 kişi, 60sn katılım süresi',
                    '  🥇 %75 birinciye, %25 ikinciye',
                    '  🌐 Toplulukta: Duyuru grubunda',
                    '     başlat, alt gruplardan katıl!',
                    ' ',
                    '⚙️ ═══ TEMEL KOMUTLAR ═══ ⚙️',
                    ' ',
                    ...
                    '!bakiye — Bakiyeni gör',
                    '!transfer @kişi <miktar> — Para at',
                    '!siralama — Liderler tablosu',
                    '!iptal — Aktif oyunu durdur',
            ...
            return msg.reply(centeredBox([
                ...
                '!yazitura · !slot · !zar',
                '!rulet · !katil (Grup oyunları)',
                ' ', '🦁 --- HAYVANAT BAHÇESİ --- 🦁',
                '!av · !savas · !market',
                '!takim · !envanter · !otoolustur',
                '!zoo → Detaylı bilgi menüsü',
                ' ', '⚔️ --- AKSİYON & SOSYAL --- ⚔️',
                ...
                ' ', '⚙️ --- TEMEL KOMUTLAR --- ⚙️',
                '!hava <şehir> · !gunluk',
                '!bakiye · !transfer · !siralama',
                '!iptal (Oyunu durdur)',
                ' ',
                '📖 !yardim full → Detaylı açıklamalar',
            ], 'TÜM KOMUTLAR'));
        }
